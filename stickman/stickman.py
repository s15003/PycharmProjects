...
class DoorSprite(Sprite):
    ...
    def animate_endgame(self, player):
        ...
        self.game.game_over = self.game.canvas.create_text(220, 250, text='Congratulations!!', font=('Times', 60))
...
if __name__=='__main__':
    ...
    platform2 = PlatformSprite(g, PhotoImage(file='platform1.gif'),
                               180, 440, 100, 10)
    platform3 = MovingPlatformSprite(g, PhotoImage(file='platform1.gif'),
                               300, 400, 100, 10)
